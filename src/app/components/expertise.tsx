...
const Expertise = () => {
  ...
  return (
    <div className="pt-[100px] px-10">
      <h2 className="font-semibold leading-[110%] text-center text-[48px] ">
      ...
      <div className="pt-[60px] max-w-[1240px] mx-auto grid grid-cols-3 gap-[30px]">
        {
            data.map((item,i)=><div className="rounded-[20px] p-[30px] flex flex-col justify-center items-center gap-y-[30px] bg-[#945600]/5" key={i}>
                ...
                <div>
                    <h3 className="text-[#040F16] text-center text-[24px] font-semibold">
                        {item.title}
                    </h3>
                    <p className="pt-[15px] text-[#767676] font-medium text-[14px] text-center ">
                        {item.desc}
                    </p>
                </div>
            </div>)
