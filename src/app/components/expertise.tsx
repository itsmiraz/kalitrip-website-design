...
const Expertise = () => {
  return (
    <div className="pt-[60px] md:pt-[60px] px-[10px] md:px-10">
      ...
      <div className="pt-[60px] md:max-w-[1240px] mx-auto justify-center items-center flex flex-wrap md:grid grid-cols-2 lg:grid-cols-3 gap-[16px] md:gap-[30px]">
        {HomeExpertiseData.map((item, i) => (
          <div
            className="rounded-[10px] w-[173px] h-fit md:h-[259px] md:w-fit md:rounded-[20px] px-[10px] py-[15px] md:py-[30px] md:px-[20px] flex flex-col justify-center items-center gap-[20px] md:gap-y-[30px] bg-[#945600]/5"
            key={i}
          >
