...
const Footer = () => {
  ...
  return (
    <div className="mt-[0px] ">
      <div className="px-[20px] mt-0 pt-0">
        <div className="w-full md:max-w-[1240px] translate-y-28 gap-x-[128px] items-center flex md:flex-row flex-col justify-between py-[30px] px-[20px] md:px-[80px] gap-y-[30px] rounded-[30px] bg-[#945600] mx-auto">
          ...
          <div>
            ...
            <p className="text-[#D8D8D8] md:text-start text-center md:text-[18px] text-[10px] font-inter  pb-[30px] md:pb-[50px] font-medium leading-[140%] ">
      ...
      {/* Footer */}
      <div className="bg-[#040F16] md:px-0 px-[10px] pb-[11px]  md:pt-[260px] pt-[200px]">
